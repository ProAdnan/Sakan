                ...
                <div class="sidebar-filters shadow-sm">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="search" class="form-control border-start-0 ps-0" placeholder="Apartment Or Location">
                        </div>
                    </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                @if ($apart->images->first())
                                    <img src="{{ asset('storage/' . $apart->images->first()->image_path) }}" alt="{{ $apart->name }}">
                                @else
                                    <div class="bg-light d-flex align-items-center justify-content-center" style="min-height: 220px;">
                            ...
                            <div class="col-md-8">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <span class="apt-price">${{ $apart->price }}<small class="text-muted fs-6 fw-normal">/{{ $apart->rent_type == 'whole' ? 'mo' : 'room' }}</small></span>
                                    </div>
                                    
                                    <div class="apt-meta">
                                        <span><i class="bi bi-geo-alt-fill"></i>{{ $apart->location }}</span>
                                        <span><i class="bi bi-mortarboard-fill"></i>{{ $apart->university->name }}</span>
                                    ...
                                    <div class="mt-auto">
                                        <a href="{{ route('apartments_d', $apart->id) }}" class="btn btn-outline-primary">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
